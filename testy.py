...
def find_contours(image,x1,x2,x3,x4):
 #19
    ...
    for cnt in contours:
        ...
        #     cv2.drawContours(color,  cnt, -1, (0, 255, 255), 3)
...
cv2.createTrackbar('win3', 'image', 3, 255, empty_callback)
...
def main():
    ...
    while True:
        ...
        for image in images:
            ...
            image=find_contours(image,okno,okno1,okno2,okno3)
